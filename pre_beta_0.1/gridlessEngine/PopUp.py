...
class popUp:
    def __init__(self, lem):
        ...
        rk_window.wm_geometry("%dx%d" % (64, 125))
        rk_window.configure(bg="gray")

        B1 = ttk.Button(rk_window, text="Coppie", command=self.Coppie,width=9 ).grid(row=1, column=0, sticky="W", pady=0)
        B2 = ttk.Button(rk_window, text="Paste", command=self.Paste, width=9).grid(row=2, column=0, sticky="W", pady=0)
        B3 = ttk.Button(rk_window, text="Edit", command=self.openEditor,width=9).grid(row=3, column=0, sticky="W", pady=0)
        B4 = ttk.Button(rk_window, text="Delete", command=self.DeleteElement,width=9 ).grid(row=4, column=0, sticky="W",                                                                            pady=0)
        B5 = ttk.Button(rk_window, text="Dublicate", command=self.Dublicate, width=9).grid(row=5, column=0, sticky="W", pady=0)
